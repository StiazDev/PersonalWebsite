  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <div className="flex flex-col px-[7.5rem] py-20 justify-start place-items-center gap-12 md:px-[3.75rem] md:gap-8 md:place-items-start lg:place-items-center xl:px-[5rem] 2xl:xl-[7.5rem] 2xl:gap-12">
