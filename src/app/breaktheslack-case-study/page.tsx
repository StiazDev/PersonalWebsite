  ...
  return (
    ...
    >
      ...
      <div className="flex gap-20 px-[7.5rem] py-20">
        <div className=" w-1/2 flex flex-col gap-12 ">
          <div className="flex flex-col gap-2">
            ...
            <p className="font-normal text-base text-white/75">
              BreakTheSlack is the tool which opened gates of backend programming for me. Initially
              I started with no design no UI. pure html input forms and data im paragraph tags.
              First I added authentication with Supabase Auth (specifically email & password Auth),
              then I made a simple to-do app with Supabase as my backend.
              <br />
              <br />
              I later learned about RLS and implemented it so that a user can only see his own rows
              of data, which improved the security of the application. I added task deletion
              functionality and handled new task form on a separate page.
              <br />
              <br />
              Then I thought that it was a pain going to a different page just to make a task every
              time. So I learned how to implement Supabase Realtime, now I handled tasked creation
              on the dashboard with the data updating in real-time.
              <br />
              <br />
              I separated To-dos from Primary Tasks by making a column called “is_primary” in the
              tasks table, which helped me keep all of the tasks in a single table but allowed me to
              differentiate between the two.
              <br />
              <br />
              <span className="font-semibold text-white/90"></span>Daily Motivation: This was a
              system which would show the user a different quote to the user every day. Meaning that
              the quote will change only the next day. I handled the problem by first creating a
              daily quotes table adding quotes from .csv files with authors. Next I wrote a function
              which would check if the quote was changed today, if not it would use Math.Random to
              get a random number which was not bigger than the rows on the daily quotes table. And
              update user’s profile on the dbs with that number. Now on that day that exact quote
              will be shown until the date changes.
            </p>
          </div>
        </div>
        <div className=" w-1/2 flex flex-col gap-12">
          <Image src={CaseStudyImg1} alt="BreakTheSlack Dashboard" className="w-full rounded-lg" />
        </div>
      </div>
      ...
      <div className="flex gap-20 px-[7.5rem] py-20">
        <div className=" w-1/2 flex flex-col gap-12 ">
          <div className="flex flex-col gap-2">
            <h2 className="font-bold text-xl">Streaks System:</h2>
            <p className="font-normal text-base text-white/75">
              ...
              cases. I started by making a flow in Miro Board. Underlining how the system will work
              with a flow diagram. Initially it worked but it had a lot of issues.
              <br />
              <br />I rewrote the whole system 4 times until I was satisfied, but it wasn’t yet
              complete. Soon enough I had to a Streak History system, and my original Streak System
              well it wasn’t built to take care of that. And here I was making changes to the streak
              system once again to make the streak history work. My implementation of streak history
              was rather incomplete, because I never implemented it.
            </p>
          </div>
          <div className="flex flex-col gap-2">
            <h2 className="font-bold text-xl">Phase 2 Streak History:</h2>
            <p className="font-normal text-base text-white/75">
              ...
              <br /> I went back to the drawing board (My Miro Board Flow Chart Diagram to be exact
              :) ), now I had to figure out firstly how do I take care of streak history, I started
              small: make a streak_history table in the dbs and add the necessary columns required,
              figure out the elements needed in the flow to just add the row to the streak_history
              table with the accurate data.
            </p>
          </div>
          <Image
            src={CaseStudyImg3}
          ...
          <p className="font-normal text-base text-white/75">
            ...
            chart is made this way. So if the streak was changed before yesterday then a new row on
            Streak History Table will be made.
            <br />
            <br />
        ...
        <div className=" w-1/2 flex flex-col gap-12 place-items-center ">
          <Image
            src={CaseStudyImg2}
        ...
        <div className=" w-1/2 flex flex-col gap-12 ">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="font-normal text-base text-white/75">
              ...
              title, requirement and milestone image. I tracked the completion of the milestones in
              the code itself. So I’d fetch all milestones and replace the image with a locked icon
              if the milestone wasn’t completed, same with the title. Now in code I would check if
              the longest_streak was {">="} streak requirement and it would unlock the content of
              the milestones. I did the same with primary tasks.
              <br />
              <br />
              ...
              developer community I hang out with. And the guy explained to me what water falls are
              and gave me advice on how to avoid them.
              <br />
              <br />
              <span className="font-bold text-white/90">Improvement:</span>
              <br />
              After removing the water falls the milestones performance went from 5 second to approx
              0.3 seconds. Which to the user felt like instant.
            </p>
          </div>
        </div>
        <div className=" w-1/2 flex flex-col gap-12 place-items-center ">
        ...
        <div className="flex flex-col gap-12 ">
          <div className="flex flex-col gap-2">
            ...
            <p className="font-normal text-base text-white/75">
              ...
              over time I thought of it as an opportunity to become something bigger than a personal
              project. I took care of everything, Design, Front-End, Back-End, Marketing, Research,
              etc. I remember the days I worked on this for 12 hours a day, it was my first ever
              software in which I did not just the front-end but also the design and back-end (And
              backend was something I have never touched in my life). So I was slow to make
              progress, but what I learned from this was something no YouTube tutorial can ever
              teach.
              <br />
              <br />
              Saying I am going to build this and actually building it are two different things, and
              for someone with my skillset it was too big of a project to handle alone. But what do
              you know, people with my mindset are quite stubborn, we don’t back down on our words.
              I learned what was necessary to bring it to life, I got stuck on problems for a week
              only to realize that it was that easy to do. But that’s where the real learning
              happens.
              <br />
              <br />
              Soon I brought a front-end Intern to my team, I wanted to take care of back-end
              (Front-End was too easy for me, no challenge is no fun). That’s where I learned how to
              transfer my knowledge to others. Sitting in Voice chats teaching where the intern gets
              stuck. And then I brought a Marketing Intern because I couldn’t do it all alone if I
              wanted to do it fast, (I could do it alone with slow speed, or I could make my
